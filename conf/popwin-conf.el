...
(add-to-list 'popwin:special-display-config '("*Help*" :height 30))
(add-to-list 'popwin:special-display-config '("*Message*" :noselect t :height 30))
...
(add-to-list 'popwin:special-display-config '("*Backtrace*" :height 30))
...
(add-to-list 'popwin:special-display-config '("*Apropos*" :noselect t :height 30))
...
(add-to-list 'popwin:special-display-config '("*magit-commit*" :noselect t :height 40 :width 80 :stick t))
